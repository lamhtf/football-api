...
public class TeamService {
    ...
    private final static String POST_SCHEDULE_JOB_DATA_PATCH_01 = "update public.team set crest_url = 'https://svgsilh.com/svg/25775.svg' where crest_url is null or crest_url like '%png%'";
